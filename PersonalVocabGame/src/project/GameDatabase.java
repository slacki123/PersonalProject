...
public class GameDatabase {
	...
	public static void createUser(String username, String password) {
		...
		String sql = "INSERT INTO user(username, password, admin_status) VALUES ('" + username + "','" + password
				+ "', false);";
		try {
	...
	public static String readNextCorrectWord(int set_id) {
		...
		try {
			String sql2 = "SELECT word_name, synonym_id FROM word WHERE set_id =" + set_id + " and synonym_id = "
					+ Game.synonymID + " ORDER BY RAND() limit 1";
			ResultSet rs = stmt.executeQuery(sql2);
